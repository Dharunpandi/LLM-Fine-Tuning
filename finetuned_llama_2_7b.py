# -*- coding: utf-8 -*-
"""finetuned_LLama_2_7B

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UGG-1f0-dJRGCVCvWuQP3_c9gYFhI1y5
"""
...
tokenizer_train_dataset=[]
for phrase in train_dataset:
  tokenizer_train_dataset.append(tokenizer(phrase['text']))

tokenizer_train_dataset[1]
...
trainer = transformers.Trainer(
    ...
    data_collator=transformersdForLanguageModeling(tokenizer, mlm=False),
)
